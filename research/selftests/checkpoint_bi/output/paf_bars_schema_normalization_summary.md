...
- Normalized CSV: `research\selftests\checkpoint_bi\output\paf_lookahead_bars.csv`
- Raw preserved copy: `research\selftests\checkpoint_bi\output\paf_lookahead_bars_raw.csv`
- Source symbol: `GOLD#`
- Source timeframe: `H1`
